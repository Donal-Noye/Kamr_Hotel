<template>
  <aside class="sidebar">
    <router-link class="logo" :to="{ name: 'Dashboard' }">
      <img class="logo__icon" src="@/assets/img/logo.svg" alt="">
      <svg class="logo__title" width="110" height="33" viewBox="0 0 110 33" fill="none">
    ...
    <div class="sidebar-profile">
      ...
      <h2 class="sidebar-profile__name heading">Alex Geovanny</h2>
      <p class="sidebar-profile__email label lg">alexgeov@mail.com</p>
    </div>
    <TheNavigation />
  </aside>
</template>
